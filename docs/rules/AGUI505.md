...
[`spec/fixtures/invalid/AGUI505-unexpected-content-type`](../../spec/fixtures/invalid/AGUI505-unexpected-content-type) and the replay
...
```json
{
  ...
  "chunks": [
    {
      "gapMs": 0,
      "text": "data: {\"type\":\"RUN_STARTED\",\"threadId\":\"thread_001\",\"runId\":\"run_001\",\"timestamp\":1755300022600}\n\n"
    },
    {
      "gapMs": 0,
      "text": "data: {\"type\":\"TEXT_MESSAGE_START\",\"messageId\":\"msg_001\",\"role\":\"assistant\",\"timestamp\":1755300022700}\n\n"
    },
    {
      "gapMs": 0,
      "text": "data: {\"type\":\"TEXT_MESSAGE_CONTENT\",\"messageId\":\"msg_001\",\"delta\":\"All good here.\",\"timestamp\":1755300022800}\n\n"
    },
    {
      "gapMs": 0,
      "text": "data: {\"type\":\"TEXT_MESSAGE_END\",\"messageId\":\"msg_001\",\"timestamp\":1755300022900}\n\n"
    },
    {
      "gapMs": 0,
      "text": "data: {\"type\":\"RUN_FINISHED\",\"threadId\":\"thread_001\",\"runId\":\"run_001\",\"outcome\":{\"type\":\"success\"},\"timestamp\":1755300023000}\n\n"
    }
  ]
}
```
